...
select * from users;
-- EASY
ALTER TABLE USERS ADD COLUMN PHONE VARCHAR(100) UNIQUE; 
SELECT * FROM USERS;
ALTER TABLE USERS ADD COLUMN DEPARTMENT VARCHAR(25) NOT NULL;
SELECT * FROM USERS;
ALTER TABLE USERS ADD COLUMN STATUS VARCHAR(25) DEFAULT "ACTIVE";
SELECT * FROM USERS;
ALTER TABLE USERS RENAME COLUMN SALARY TO MONTHLY_SALARY;
SELECT * FROM USERS;
ALTER TABLE USERS MODIFY COLUMN NAME varchar(150) not null;
SELECT * FROM USERS;
-- INTERMEDIATE
ALTER TABLE USERS DROP COLUMN ID;
ALTER TABLE USERS ADD COLUMN ID INT PRIMARY KEY AUTO_INCREMENT AFTER NAME;
SELECT * FROM USERS;
ALTER TABLE USERS ADD CONSTRAINT CHECK_SALARY CHECK (MONTHLY_SALARY > 30000);
SELECT * FROM USERS;
INSERT INTO USERS(NAME, EMAIL, GENDER,DATE_OF_BIRTH, MONTHLY_SALARY, PHONE, DEPARTMENT) VALUES('RAGHAV','RAGHAV@GMAIL.COM','OTHER','1990-12-12',670000.99,'4583439','PHYSICS');
SELECT * FROM USERS;
INSERT INTO USERS(NAME, EMAIL, GENDER,DATE_OF_BIRTH, MONTHLY_SALARY, PHONE, DEPARTMENT) VALUES('RAGHA','RAGHV@GMAIL.COM','OTHER','1990-12-12',80000.99,'45834939','PHYSICS');
SELECT * FROM USERS;
ALTER TABLE USERS ADD COLUMN EXPERIENCE INT CHECK (EXPERIENCE >= 0);
SELECT * FROM USERS;
ALTER TABLE USERS ADD CONSTRAINT UNIQUE_EMAIL UNIQUE(EMAIL);
ALTER TABLE USERS DROP CONSTRAINT UNIQUE_EMAIL;
ALTER TABLE USERS ADD UNIQUE (EMAIL);
ALTER TABLE USERS ADD COLUMN BONUS INT DEFAULT '5000', ADD COLUMN CITY VARCHAR(250) NOT NULL;
SELECT * FROM USERS;
-- HARD
SHOW INDEX FROM USERS;
ALTER TABLE USERS DROP INDEX PHONE;
SELECT * FROM USERS;
INSERT INTO USERS(NAME, EMAIL, GENDER,DATE_OF_BIRTH, MONTHLY_SALARY, PHONE, DEPARTMENT, CITY) VALUES('RAGAV','RAGH@GMAIL.COM','OTHER','1980-12-12',670000.99,'9999','PHYSS','DEHI');
SELECT * FROM USERS;
INSERT INTO USERS(NAME, EMAIL, GENDER,DATE_OF_BIRTH, MONTHLY_SALARY, PHONE, DEPARTMENT, CITY) VALUES('RAHA','RAV@GMAIL.COM','OTHER','1990-12-12',80000.99,'9999','PHYCS','PUNJA');
SELECT * FROM USERS;
